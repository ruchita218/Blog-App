...
const About = () => {
    ...
    return (
        <Box>
            <Banner/>
            <Wrapper>
                <Typography variant="h3">Give your blog the perfect home.</Typography>
                <Text variant="h5">Save the moments that matter. Blogger lets you safely store thousands of posts, photos, and more..
                ...
                Publish your passions your way. Whether you'd like to share your knowledge, experiences or the latest news, create a unique and beautiful blog
                    <Box component="span" style={{ marginLeft: 5 }}>
                        <Link href="https://github.com/ruchita218" color="inherit" target="_blank"><GitHub /></Link>
                    </Box>
                </Text>
                <Text variant="h5">
